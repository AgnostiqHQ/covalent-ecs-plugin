...
ECS_EXECUTOR_TASK_FAMILY_NAME = terraform_output.get("ecs_task_family_name","covalent-fargate-tasks")
ECS_EXECUTOR_EXECUTION_ROLE_NAME = terraform_output.get("ecs_task_execution_role_name","ecsTaskExecutionRole")
ECS_EXECUTOR_TASK_ROLE_NAME = terraform_output.get("ecs_task_role_name","CovalentFargateTaskRole")
ECS_EXECUTOR_TASK_LOG_GROUP_NAME = terraform_output.get("ecs_task_log_group_name","covalent-fargate-task-logs")
...
executor_config = {
    ...
    "ecs_task_family_name": os.getenv("ECS_EXECUTOR_TASK_FAMILY_NAME", ECS_EXECUTOR_TASK_FAMILY_NAME),
    "ecs_task_execution_role_name": os.getenv("ECS_EXECUTOR_EXECUTION_ROLE_NAME", ECS_EXECUTOR_EXECUTION_ROLE_NAME),
    "ecs_task_role_name": os.getenv("ECS_EXECUTOR_TASK_ROLE_NAME",ECS_EXECUTOR_TASK_ROLE_NAME),
    "ecs_task_log_group_name": os.getenv("ECS_EXECUTOR_TASK_LOG_GROUP_NAME",ECS_EXECUTOR_TASK_LOG_GROUP_NAME),
    "ecs_task_subnet_id": os.getenv("ECS_EXECUTOR_TASK_SUBNET_ID",ECS_EXECUTOR_TASK_SUBNET_ID),
    "ecs_task_security_group_id": os.getenv("ECS_EXECUTOR_TASK_SECURITY_GROUP_NAME",ECS_EXECUTOR_TASK_SECURITY_GROUP_NAME),
